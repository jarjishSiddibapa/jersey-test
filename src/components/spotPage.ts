    ...
    return `
      <div class="spot-page">
        <div class="container spot-page__inner spot-page__inner--empty">
          ...
          <h1 class="legal-title">Nobody's called dibs on this one yet.</h1>
          <p>Be the first name here.</p>
          <a href="#/" class="btn btn-accent" style="margin-top:16px;display:inline-flex;">Go call dibs</a>
        </div>
      </div>
    `;
  }
    ...
    <div class="spot-page">
      <div class="container spot-page__inner">
        ...
        <div class="spot-page__card">
          ...
          <button class="btn btn-ghost btn-block" data-action="share-spot-page" data-spot-id="${spot.id}" style="margin-top:14px;">Show it off</button>
