  ...
  const rows = entries.length
    ? entries
        ...
        <div class="activity-row">
          ...
          <span class="activity-row__mid">called dibs on Spot #${entry.spotId}</span>
      ...
      `,
        ...
        .join("")
    : `<div class="activity-empty">Nobody's called dibs yet. Be the first name on the jersey.</div>`;

  return `
    <section class="section section--tight" id="activity">
      <div class="container">
        <p class="section-eyebrow">Live</p>
        <h2 class="section-title">Fresh dibs</h2>
        <p class="section-subtitle">${
          hasDemo
            ? "Includes seeded demonstration data for this prototype."
            : "People who called dibs before you did."
        }</p>
